...
async def sqrt_test(dut):
    ...
    # Init dut signals. Order has no influence
    dut.arg_valid.value = 0
    # dut.arg.value = 0    # data, not a control signal. Leaving in unknown state does not cause errors
...
def simulation_runner():
    ...
    runner.test(hdl_toplevel="square_root", 
				test_module="lab02_cocotb_solution",
